...
async def chat(user_input: UserInput):
    ...
    try:
        results = chroma_store.query_documents(query_text=user_message, user_id="embedding_collection")
...
async def extract(article_input: ArticleInput):
    ...
    try:
        chroma_store.embed_documents(texts=extracted_content, user_id="embedding_collection")
